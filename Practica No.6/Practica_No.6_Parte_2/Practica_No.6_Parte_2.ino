...
#define pin_buzz  10           //pin10 buzz
#define led_rojo  A1           //pin6 conectado al led rojo
#define led_amar  A2           //pin12 conectado al led amarillo
#define led_verd  A3            //pin7 conectado al led verde
...
String contrasenaCerradura = "2023102*";   //Variable donde almaceno la contraseña definida por el sistema
...
//Constructor
LiquidCrystal_I2C lcdCerradura(direccion_lcd, columnas, filas);   //LCD con direccion 0x20 y tamano 16x2
